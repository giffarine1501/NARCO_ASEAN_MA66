<div class="container p-4">
    <div class="row">
        ...
        <div class="col-12 col-sm-3 col-md-3 col-lg-2 mb-2 btn-center">
            <button type="button" class="btn-all" onclick="window.location='mor_news.php'">
    ...
    <div class="row">
        <div class="col-12 p-0">
            <ul class="nav nav-tabs jus-center" id="myTab" role="tablist">
                <li class="nav-item " role="presentation">
                    <button type="button" class="nav-link active p-topic" id="button-tap1" data-toggle="tab"
                        data-target="#button1" role="tab" aria-controls="button1" aria-selected="true">
                        <h5 class="color-topic2 fs-18"> ข่าวทั่วไป</h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link p-topic" id="button-tap2" data-toggle="tab"
                        data-target="#button2" role="tab" aria-controls="button2" aria-selected="true">
                        <h5 class="color-topic2 fs-18"> ข่าวล่าสุด</h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    </button>
                    <button type="button" class="nav-link p-topic" id="button-tap3" data-toggle="tab"
                        data-target="#button3" role="tab" aria-controls="button3" aria-selected="true">
                        <h5 class="color-topic2 fs-18"> ข่าวยอดนิยม</h5>
                    </button>
                </li>
            </ul>
        </div>
                ...
                <div class="col-12 col-sm-3 col-md-6 col-lg-3 mt-3">
                    <div class="card-news shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled date-view d-flex justify-content-between">
                                <li><i class="fas fa-calendar"></i> 27 มกราคม 2566</li>
                                <li><i class="fas fa-eye"></i> 35</li>
                            </ul>
                        </div>
                    </div>
                </div>
