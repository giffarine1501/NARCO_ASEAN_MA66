        ...
        <div class="col-12 p-0">
            <ul class="nav nav-tabs jus-center" id="myTab" role="tablist">
                <li class="nav-item " role="presentation">
                    <button type="button" class="nav-link active " id="button-tap1" data-toggle="tab"
                        data-target="#button1" role="tab" aria-controls="button1" aria-selected="true">
                        <h5 class="color-topic2 fs-18"> ข่าวทั่วไป</h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link " id="button-tap2" data-toggle="tab"
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <button type="button" class="nav-link " id="button-tap3" data-toggle="tab"
